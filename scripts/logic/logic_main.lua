...
golden_sun_the_lost_age_location = {}
golden_sun_the_lost_age_location.__index = golden_sun_the_lost_age_location
...
function golden_sun_the_lost_age_location.new(name)
    local self = setmetatable({}, golden_sun_the_lost_age_location)
    if name then
...
function golden_sun_the_lost_age_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        exit = golden_sun_the_lost_age_location.new(exit)
    end
    if rule == nil then
        rule = always
    end
...
function golden_sun_the_lost_age_location:connect_two_ways(exit, rule)
...
function golden_sun_the_lost_age_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function golden_sun_the_lost_age_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function golden_sun_the_lost_age_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function golden_sun_the_lost_age_location:accessibility()
...
-- 
function golden_sun_the_lost_age_location:discover(accessibility, keys)
...
entry_point = golden_sun_the_lost_age_location.new("entry_point")
